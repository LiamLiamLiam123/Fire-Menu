/*
 * Fire Menu  Managers/CustomBoardManager.cs
...
namespace Fire.Managers
{
    public class CustomBoardManager : MonoBehaviour
    {
        ...
        public static string motdTemplate = "You are using build {0}. This menu was created by Fire Software. " +
        ...
        "<color=red>Fire is not responsible for any bans using this menu.</color> " +
