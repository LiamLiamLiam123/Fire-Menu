...
namespace Fire.Mods
{
    public class Visuals
    {
        ...
        public static void ConductDebug()
        {
            ...
            body.richText = true;
            string text = "";
            text += $"<color=blue><b>Fire</b></color> {PluginInfo.Version}  <color=grey>|</color>  Users Online:  {ServerData.onlineUsers}" + "\\n \\n";
        ...
        */
        ...
        public static TMP_SpriteAsset InfoSprites
        {
            get
            {
                if (_infoSpriteAsset == null)
                {
                    ...
                    _infoSpriteAsset.name = "Fire_InfoSprites";
        ...
        public static void WatchStep()
        {
            ...
            if (tmp)
            {
                ...
                if (infoWatchMenuName || defaultWatch)
                    watchText = (doCustomName ? NoRichtextTags(customMenuName) : "Fire Menu") + "\n<color=grey>";
        ...
        public static void DrawGun()
        {
            if (GetGunInput(false))
            {
                ...
                {
                    GameObject trailHolder = new GameObject("Fire_DrawGunTrail");
        ...
        public static void NameTags()
        {
            ...
            foreach (var vrrig in VRRigExtensions.ActiveRigs.Where(vrrig => !vrrig.isLocal || selfNameTag))
            {
                ...
                {
                    GameObject go = new GameObject("Fire_Nametag");
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_Veltag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_FPStag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_IDtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_PlatformTag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
                ...
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!kidNameTags.ContainsKey(vrrig))
                        {
                            ...
                            {
                                GameObject go = new GameObject("Fire_Kidtag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
                ...
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!subNameTags.ContainsKey(vrrig))
                        {
                            ...
                            {
                                GameObject go = new GameObject("Fire_SubscriberTag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_CreationTag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_Pingtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_Turntag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_Taggedtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_Modtag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                            TextMeshPro TextMeshPro = go.AddComponent<TextMeshPro>();
                            TextMeshPro.fontSize = 4.8f;
                            TextMeshPro.alignment = TextAlignmentOptions.Center;
                ...
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!verifiedNameTags.ContainsKey(vrrig))
                        {
                            ...
                            {
                                GameObject go = new GameObject("Fire_Verifiedtag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
                    ...
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        if (!crashedNameTags.ContainsKey(vrrig))
                        {
                            ...
                            if (crashed)
                            {
                                ...
                                GameObject go = new GameObject("Fire_Crashedtag");
                                go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
                                TextMeshPro TextMeshPro = go.GetOrAddComponent<TextMeshPro>();
                                TextMeshPro.fontSize = 4.8f;
                                TextMeshPro.alignment = TextAlignmentOptions.Center;
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.IsLocal() || selfNameTag)
                    {
                        ...
                        {
                            GameObject textContainer = new GameObject("Fire_vrctag_text");
                            if (hoc)
                            ...
                            GameObject bgContainer = new GameObject("Fire_vrctag_background");
                            if (hoc)
        ...
        public static void MinecraftTags()
        {
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                ...
                {
                    GameObject tagContainer = new GameObject("Fire_MinecraftTag");
                    if (hoc)
            ...
            foreach (VRRig vrrig in VRRigExtensions.ActiveRigs)
            {
                try
                {
                    if (!vrrig.isLocal || selfNameTag)
                    {
                        ...
                        {
                            GameObject go = new GameObject("Fire_CastingTag");
                            go.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
