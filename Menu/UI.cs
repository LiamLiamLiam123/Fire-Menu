...
namespace Fire.Menu
{
    public class UI : MonoBehaviour
    {
        ...
        private readonly string hideGUIPath = $"{PluginInfo.BaseDirectory}/Fire_HideGUI.txt";
        private void ToggleGUI()
        {
            ...
            try
            {
                ...
                {
                    if (!File.Exists(hideGUIPath))
                        File.WriteAllText(hideGUIPath, "Text file generated with Fire Menu");
                }
            }
            catch { }
